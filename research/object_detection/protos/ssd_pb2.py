...
_SSD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multi_task_label', full_name='object_detection.protos.Ssd.multi_task_label', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='class_predictor', full_name='object_detection.protos.Ssd.class_predictor', index=12,
...
_SSD.fields_by_name['multi_task_label'].message_type = object_detection.protos.multi_task_label_pb2._MULTITASKLABEL
_SSD.fields_by_name['class_predictor'].message_type = object_detection.protos.class_predictor_pb2._CLASSPREDICTOR
