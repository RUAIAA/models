...
_INPUTREADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multi_task_class_name', full_name='object_detection.protos.InputReader.multi_task_class_name', index=9,
